...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['branch-manager', 'business-owner', 'sales-representative', 'service-representative'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Test Rides', path: '/test-rides', entity: 'test_ride', service: AccessServiceEnum.PROJECT, icon: FiBox },
