  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless segregation with VAANE - Your ultimate solution for branch-wise service and sales tracking, from total amount to test rides, enquiries, and more."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1661956600684-97d3a4320e45?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxzYWxlc3xlbnwwfHx8fDE2OTEyNDU5ODJ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless segregation with VAANE - Your ultimate solution for branch-wise service and sales tracking, from total amount to test rides, enquiries, and more.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                <Card userTypeName="Branch Manager" type="branch-manager" />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
