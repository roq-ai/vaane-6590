...
import { getSalesRecordById } from 'apiSdk/sales-records';
import { SalesRecordInterface } from 'interfaces/sales-record';

function SalesRecordViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('sales_record', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/sales-records/edit/${id}`} passHref legacyBehavior>
                    <Button
